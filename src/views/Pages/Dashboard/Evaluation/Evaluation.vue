    ...
    <el-card shadow="never" style="border:none">
        <div class="mb-4 flex lg:flex-row md:flex-row gap-4 flex-col justify-between items-center">
            <div class="w-full lg:w-1/2 md:w-1/2">
                <h1 class="text-xl font-semibold">Kelola Penilaian</h1>
            </div>
        </div>
...
const customColumns = ref([
    ...
    { prop: "periode_pendaftaran_id", label: "Periode", width: 180 },
...
const openPotentialBeneficiary = (data: any,) => {
    router.push({ name: 'ranking-evaluation-potential-beneficiary', params: { id: router.currentRoute.value.params.id, submission_id: data.id } })
}
