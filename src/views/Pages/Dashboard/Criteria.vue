    ...
    <el-card shadow="never" style="border:none">
        ...
        <div class="my-4 flex lg:flex-row md:flex-row gap-4 justify-between items-center">
            ...
            <div class="flex lg:flex-row md:flex-row items-center justify-end gap-5 w-1/2">
                <el-input placeholder="Cari Kriteria ..." v-model="searchQuery" prefix-icon="el-icon-search"
                    class="lg:w-1/2 md:w-1/2 w-full" clearable />
            </div>
        </div>

        <div>
            <Datatable :selection="true" :items="criterias" :pagination="pagination" :loading="loading"
                ...
                <template #actions="{ row }">
                    <el-tooltip class="box-item" effect="dark" content="Atur Sub Kriteria" placement="top-start">
                        <el-button plain type="primary" size="small" @click="openSubCriteria(row)"
                            :icon="List"></el-button>
                    </el-tooltip>
            ...
            <crud-modal v-model:visible="crudModalVisible" :mode="crudModalMode" :data="crudModalData"
                ...
                name="Kriteria Bantuan" :create-service="store.createData" :update-service="store.updateData"
