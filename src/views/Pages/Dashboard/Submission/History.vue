            ...
            >
                ...
                <template #actions="{ row }">
                    <el-tooltip
                        ...
                        placement="top-start"
                    >
                        <el-button plain v-if="row.status == 'terima' || row.status == 'tutup'" type="primary" size="small" @click="openPotentialBeneficiary(row)" :icon="User"></el-button>
                    </el-tooltip>
                    <el-tooltip
                        class="box-item"
                        effect="dark"
                    ...
                    <el-tooltip
                        ...
                        placement="top-start"
                    >
                        <el-button plain v-if="row.status == 'verifikasi'" type="danger" size="small" @click="openCrudModal('delete', row)" :icon="Delete" ></el-button>
                    </el-tooltip>
                </template>
            </Datatable>
            <crud-modal
